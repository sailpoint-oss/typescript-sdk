...
const result = await apiInstance.approveApprovalInBulkV1(bulkapproverequestdtoV1);
console.log(result);
```
...
const result = await apiInstance.approveApprovalV1(id);
console.log(result);
```
...
const result = await apiInstance.cancelApprovalByIdV1(id);
console.log(result);
```
...
const result = await apiInstance.cancelApprovalV1(bulkcancelrequestdtoV1);
console.log(result);
```
...
const result = await apiInstance.deleteApprovalConfigRequestV1(id, scope);
console.log(result);
```
...
const result = await apiInstance.getApprovalV1(id);
console.log(result);
```
...
const result = await apiInstance.getApprovalsConfigV1(id);
console.log(result);
```
...
const result = await apiInstance.moveApprovalV1(bulkreassignrequestdtoV1);
console.log(result);
```
...
const result = await apiInstance.putApprovalsConfigV1(id, scope, approvalconfigV1);
console.log(result);
```
...
const result = await apiInstance.rejectApprovalInBulkV1(bulkrejectrequestdtoV1);
console.log(result);
```
...
const result = await apiInstance.rejectApprovalV1(id);
console.log(result);
```
...
const result = await apiInstance.updateApprovalsAttributesV1(id, approvalattributesrequestV1);
console.log(result);
```
...
const result = await apiInstance.updateApprovalsCommentsV1(id, approvalcommentsrequestV1);
console.log(result);
```
...
const result = await apiInstance.updateApprovalsReassignV1(id, approvalreassignrequestV1);
console.log(result);
```
