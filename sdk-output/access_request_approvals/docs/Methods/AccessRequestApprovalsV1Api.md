...
const result = await apiInstance.forwardAccessRequestV1(approvalId, forwardapprovaldtoV1);
console.log(result);
```
...
const result = await apiInstance.listAccessRequestApproversV1(accessRequestId);
console.log(result);
```
...
const result = await apiInstance.rejectAccessRequestV1(approvalId, commentdtoV1);
console.log(result);
```
