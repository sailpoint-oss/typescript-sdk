...
const result = await apiInstance.createLauncherV1(launcherrequestV1);
console.log(result);
```
...
const result = await apiInstance.deleteLauncherV1(launcherID);
console.log(result);
```
...
const result = await apiInstance.getLauncherV1(launcherID);
console.log(result);
```
...
const result = await apiInstance.putLauncherV1(launcherID, launcherrequestV1);
console.log(result);
```
...
const result = await apiInstance.startLauncherV1(launcherID);
console.log(result);
```
