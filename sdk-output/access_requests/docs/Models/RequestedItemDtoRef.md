...
keywords: ['typescript', 'TypeScript', 'sdk', 'RequestedItemDtoRef', 'v1RequestedItemDtoRef']
slug: /tools/sdk/typescript/access_requests/models/requested-item-dto-ref
...
------------ | ------------- | ------------- | -------------
**type** | `string` | The type of the item being requested. * Machine identity access requests support `ENTITLEMENT` only.  | [default to undefined]
