...
const result = await apiInstance.deleteParameterV1(id);
console.log(result);
```
...
const result = await apiInstance.getAttestationDocumentV1(key);
console.log(result);
```
...
const result = await apiInstance.getParameterReferencesV1(id);
console.log(result);
```
...
const result = await apiInstance.getParameterV1(id);
console.log(result);
```
...
const result = await apiInstance.updateParameterV1(id);
console.log(result);
```
