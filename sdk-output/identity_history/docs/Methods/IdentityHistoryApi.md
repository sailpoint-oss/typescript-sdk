...
```typescript
import { IdentityHistoryApi } from '/api-client';
...
`Array<GetHistoricalIdentityEventsV1200ResponseInner>`
...
`Array<ListIdentityAccessItemsV1200ResponseInner>`
...
`Array<ListIdentitySnapshotAccessItemsV1200ResponseInner>`
