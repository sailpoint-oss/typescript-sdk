...
const result = await apiInstance.cancelTaskV1(id);
console.log(result);
```
...
const result = await apiInstance.createApplicationV1(basecreateapplicationrequestV1);
console.log(result);
```
...
const result = await apiInstance.createIdentityCollectorV1(createidentitycollectorrequestV1);
console.log(result);
```
...
const result = await apiInstance.createScheduleV1(createschedulerequestV1);
console.log(result);
```
...
const result = await apiInstance.dasV1OwnersAssignPost(assignresourceownerrequestV1);
console.log(result);
```
...
const result = await apiInstance.dasV1OwnersOwnerIdentityIdResourcesGet(ownerIdentityId);
console.log(result);
```
...
const result = await apiInstance.dasV1OwnersReelectPost(reelectrequestV1);
console.log(result);
```
...
const limit: number = 250; // Not applicable for this endpoint. Do not use. (optional)
const offset: number = 0; // Not applicable for this endpoint. Do not use. (optional)
const result = await apiInstance.dasV1OwnersResourcesResourceIdGet(resourceId);
console.log(result);
```
...
const result = await apiInstance.dasV1OwnersSourceIdentityIdReassignDestinationIdentityIdPost(sourceIdentityId, destinationIdentityId);
console.log(result);
```
...
const result = await apiInstance.deleteApplicationV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteIdentityCollectorV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteScheduleV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteTaskV1(id);
console.log(result);
```
...
const result = await apiInstance.getApplicationV1(id);
console.log(result);
```
...
const limit: number = 250; // Not applicable for this endpoint. Do not use. (optional)
const offset: number = 0; // Not applicable for this endpoint. Do not use. (optional)
const result = await apiInstance.getOwnersV1(appId);
console.log(result);
```
...
const result = await apiInstance.getScheduleV1(id);
console.log(result);
```
...
const result = await apiInstance.getTaskV1(id);
console.log(result);
```
...
const result = await apiInstance.putApplicationV1(id, basecreateapplicationrequestV1);
console.log(result);
```
...
const result = await apiInstance.putIdentityCollectorV1(id, updateidentitycollectorrequestV1);
console.log(result);
```
...
const result = await apiInstance.putScheduleV1(id, updateschedulerequestV1);
console.log(result);
```
...
const result = await apiInstance.startTaskRerunV1(id);
console.log(result);
```
