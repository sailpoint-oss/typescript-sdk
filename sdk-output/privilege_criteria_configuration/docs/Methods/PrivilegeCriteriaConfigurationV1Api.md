...
const result = await apiInstance.getPrivilegeCriteriaConfigV1(criteriaConfigId);
console.log(result);
```
...
const result = await apiInstance.listPrivilegeCriteriaConfigV1(filters);
console.log(result);
```
...
const result = await apiInstance.patchPrivilegeCriteriaConfigV1(criteriaConfigId, requestBody);
console.log(result);
```
