...
const result = await apiInstance.createTransformV1(transformV1);
console.log(result);
```
...
const result = await apiInstance.deleteTransformV1(id);
console.log(result);
```
...
const result = await apiInstance.getTransformV1(id);
console.log(result);
```
...
const result = await apiInstance.updateTransformV1(id);
console.log(result);
```
