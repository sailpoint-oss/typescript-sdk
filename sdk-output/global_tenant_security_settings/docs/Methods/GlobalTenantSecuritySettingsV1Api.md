...
const result = await apiInstance.createAuthOrgNetworkConfigV1(networkconfigurationV1);
console.log(result);
```
...
const result = await apiInstance.patchAuthOrgLockoutConfigV1(jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.patchAuthOrgNetworkConfigV1(jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.patchAuthOrgServiceProviderConfigV1(jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.patchAuthOrgSessionConfigV1(jsonpatchoperationV1);
console.log(result);
```
