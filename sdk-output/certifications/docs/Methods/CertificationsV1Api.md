...
const result = await apiInstance.getCertificationTaskV1(id);
console.log(result);
```
...
const result = await apiInstance.getIdentityCertificationItemPermissionsV1(certificationId, itemId);
console.log(result);
```
...
const result = await apiInstance.getIdentityCertificationV1(id);
console.log(result);
```
...
const result = await apiInstance.listCertificationReviewersV1(id);
console.log(result);
```
...
const result = await apiInstance.listIdentityAccessReviewItemsV1(id);
console.log(result);
```
...
const result = await apiInstance.makeIdentityDecisionV1(id, reviewdecisionV1);
console.log(result);
```
...
const result = await apiInstance.reassignIdentityCertificationsV1(id, reviewreassignV1);
console.log(result);
```
...
const apiInstance = new CertificationsV1Api(configuration);
const id: string = ef38f94347e94562b5bb8424a56397d8; // The identity campaign certification ID
const result = await apiInstance.signOffIdentityCertificationV1(id);
console.log(result);
```
...
const id: string = ef38f94347e94562b5bb8424a56397d8; // The identity campaign certification ID
const reviewreassignV1: ReviewreassignV1 = ; // 
const result = await apiInstance.submitReassignCertsAsyncV1(id, reviewreassignV1);
console.log(result);
```
