...
const result = await apiInstance.createAccessProfileV1(accessprofileV1);
console.log(result);
```
...
const result = await apiInstance.deleteAccessProfileV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteAccessProfilesInBulkV1(accessprofilebulkdeleterequestV1);
console.log(result);
```
...
const result = await apiInstance.getAccessProfileEntitlementsV1(id);
console.log(result);
```
...
const result = await apiInstance.getAccessProfileV1(id);
console.log(result);
```
...
const result = await apiInstance.patchAccessProfileV1(id, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.updateAccessProfilesInBulkV1(accessprofilebulkupdaterequestInnerV1);
console.log(result);
```
