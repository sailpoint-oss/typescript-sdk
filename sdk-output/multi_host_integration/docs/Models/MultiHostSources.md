...
keywords: ['typescript', 'TypeScript', 'sdk', 'MultiHostSources', 'v1MultiHostSources']
slug: /tools/sdk/typescript/multi_host_integration/models/multi-host-sources
...
**managerCorrelationMapping** | **(optional)** `ManagerCorrelationMapping` |  | [default to undefined]
**managerCorrelationRule** | **(optional)** `MultiHostIntegrationsManagerCorrelationRule` |  | [default to undefined]
**beforeProvisioningRule** | **(optional)** `MultiHostSourcesBeforeProvisioningRule` |  | [default to undefined]
