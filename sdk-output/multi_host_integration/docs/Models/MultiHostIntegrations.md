...
keywords: ['typescript', 'TypeScript', 'sdk', 'MultiHostIntegrations', 'v1MultiHostIntegrations']
slug: /tools/sdk/typescript/multi_host_integration/models/multi-host-integrations
...
**accountCorrelationConfig** | **(optional)** `MultiHostIntegrationsAccountCorrelationConfig` |  | [default to undefined]
**accountCorrelationRule** | **(optional)** `MultiHostIntegrationsAccountCorrelationRule` |  | [default to undefined]
**managerCorrelationMapping** | **(optional)** `MultiHostIntegrationsManagerCorrelationMapping` |  | [default to undefined]
**managerCorrelationRule** | **(optional)** `MultiHostIntegrationsManagerCorrelationRule` |  | [default to undefined]
**beforeProvisioningRule** | **(optional)** `MultiHostIntegrationsBeforeProvisioningRule` |  | [default to undefined]
**schemas** | **(optional)** `Array<MultiHostIntegrationsSchemasInner>` | List of references to schema objects. | [default to undefined]
**passwordPolicies** | **(optional)** `Array<MultiHostIntegrationsPasswordPoliciesInner>` | List of references to the associated PasswordPolicy objects. | [default to undefined]
...
**connectorAttributes** | **(optional)** `MultiHostIntegrationsConnectorAttributes` |  | [default to undefined]
...
**accountsFile** | **(optional)** `MultiHostIntegrationsAccountsFile` |  | [default to undefined]
