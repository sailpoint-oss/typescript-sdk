...
const result = await apiInstance.createDomainDkimV1(domainaddressV1);
console.log(result);
```
...
const result = await apiInstance.createNotificationTemplateV1(templatedtoV1);
console.log(result);
```
...
const result = await apiInstance.createVerifiedFromAddressV1(emailstatusdtoV1);
console.log(result);
```
...
const result = await apiInstance.deleteNotificationTemplatesInBulkV1(templatebulkdeletedtoV1);
console.log(result);
```
...
const result = await apiInstance.deleteVerifiedFromAddressV1(id);
console.log(result);
```
...
const result = await apiInstance.getMailFromAttributesV1(identity);
console.log(result);
```
...
const result = await apiInstance.getNotificationPreferencesV1(key);
console.log(result);
```
...
const result = await apiInstance.getNotificationTemplateV1(id);
console.log(result);
```
...
const result = await apiInstance.getNotificationTemplateVariablesV1(key, medium);
console.log(result);
```
...
const result = await apiInstance.putMailFromAttributesV1(mailfromattributesdtoV1);
console.log(result);
```
...
const result = await apiInstance.sendTestNotificationV1(sendtestnotificationrequestdtoV1);
console.log(result);
```
