...
```typescript
import { CertificationCampaignsApi } from '/api-client';
import { Configuration } from '/api-client';
import { CampaignCompleteOptions } from '/api-client/dist/certification_campaigns/api';
...
import { CertificationCampaignsApi } from '/api-client';
import { Configuration } from '/api-client';
import { CampaignTemplate } from '/api-client/dist/certification_campaigns/api';
...
import { CertificationCampaignsApi } from '/api-client';
import { Configuration } from '/api-client';
import { Campaign2 } from '/api-client/dist/certification_campaigns/api';

const configuration = new Configuration();
const apiInstance = new CertificationCampaignsApi(configuration);
const campaign2: Campaign2 = ; // 
const result = await apiInstance.createCampaignV1({ campaign2: campaign2 });
console.log(result);
```
...
import { CertificationCampaignsApi } from '/api-client';
import { Configuration } from '/api-client';
import { CampaignsDeleteRequest } from '/api-client/dist/certification_campaigns/api';
...
`Array<GetActiveCampaignsV1200ResponseInner>`
...
import { CertificationCampaignsApi } from '/api-client';
import { Configuration } from '/api-client';
import { AdminReviewReassign } from '/api-client/dist/certification_campaigns/api';
...
import { CertificationCampaignsApi } from '/api-client';
import { Configuration } from '/api-client';
import { JsonPatchOperation } from '/api-client/dist/certification_campaigns/api';
...
import { CertificationCampaignsApi } from '/api-client';
import { Configuration } from '/api-client';
import { CampaignReportsConfig } from '/api-client/dist/certification_campaigns/api';
...
import { CertificationCampaignsApi } from '/api-client';
import { Configuration } from '/api-client';
import { Schedule2 } from '/api-client/dist/certification_campaigns/api';

const configuration = new Configuration();
const apiInstance = new CertificationCampaignsApi(configuration);
const id: string = 04bedce387bd47b2ae1f86eb0bb36dee; // ID of the campaign template being scheduled.
const schedule2: Schedule2 = {"type":"MONTHLY","hours":{"type":"LIST","values":["17"]},"days":{"type":"LIST","values":["15"]}}; //  (optional)
...
import { CertificationCampaignsApi } from '/api-client';
import { Configuration } from '/api-client';
import { ActivateCampaignOptions } from '/api-client/dist/certification_campaigns/api';
