...
const result = await apiInstance.completeCampaignV1(id);
console.log(result);
```
...
const result = await apiInstance.createCampaignTemplateV1(campaigntemplateV1);
console.log(result);
```
...
const result = await apiInstance.createCampaignV1(campaign2V1);
console.log(result);
```
...
const result = await apiInstance.deleteCampaignTemplateScheduleV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteCampaignTemplateV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteCampaignsV1(campaignsdeleterequestV1);
console.log(result);
```
...
const result = await apiInstance.getCampaignReportsV1(id);
console.log(result);
```
...
const result = await apiInstance.getCampaignTemplateScheduleV1(id);
console.log(result);
```
...
const result = await apiInstance.getCampaignTemplateV1(id);
console.log(result);
```
...
const detail: string = FULL; // Determines whether slim, or increased level of detail is provided for each campaign in the returned list. Slim is the default behavior. (optional)
const result = await apiInstance.getCampaignV1(id);
console.log(result);
```
...
const result = await apiInstance.moveV1(id, adminreviewreassignV1);
console.log(result);
```
...
const result = await apiInstance.patchCampaignTemplateV1(id, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.setCampaignReportsConfigV1(campaignreportsconfigV1);
console.log(result);
```
...
const result = await apiInstance.setCampaignTemplateScheduleV1(id);
console.log(result);
```
...
const result = await apiInstance.startCampaignRemediationScanV1(id);
console.log(result);
```
...
const result = await apiInstance.startCampaignReportV1(id, type);
console.log(result);
```
...
const result = await apiInstance.startCampaignV1(id);
console.log(result);
```
...
const result = await apiInstance.startGenerateCampaignTemplateV1(id);
console.log(result);
```
...
const result = await apiInstance.updateCampaignV1(id, jsonpatchoperationV1);
console.log(result);
```
