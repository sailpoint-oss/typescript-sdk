...
const result = await apiInstance.cancelReportV1(id);
console.log(result);
```
...
const result = await apiInstance.getReportResultV1(taskResultId);
console.log(result);
```
...
const result = await apiInstance.getReportV1(taskResultId, fileFormat);
console.log(result);
```
...
const result = await apiInstance.startReportV1(reportdetailsV1);
console.log(result);
```
