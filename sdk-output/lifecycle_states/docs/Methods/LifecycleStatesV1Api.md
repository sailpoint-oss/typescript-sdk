...
const result = await apiInstance.createLifecycleStateV1(identityProfileId, lifecyclestateV1);
console.log(result);
```
...
const result = await apiInstance.deleteLifecycleStateV1(identityProfileId, lifecycleStateId);
console.log(result);
```
...
const identityProfileId: string = 2b838de9-db9b-abcf-e646-d4f274ad4238; // Identity profile ID.
const lifecycleStateId: string = ef38f94347e94562b5bb8424a56397d8; // Lifecycle state ID.
const result = await apiInstance.getLifecycleStateV1(identityProfileId, lifecycleStateId);
console.log(result);
```
...
const result = await apiInstance.getLifecycleStatesV1(identityProfileId);
console.log(result);
```
...
const result = await apiInstance.setLifecycleStateV1(identityId, setLifecycleStateV1RequestV1);
console.log(result);
```
...
const result = await apiInstance.updateLifecycleStatesV1(identityProfileId, lifecycleStateId, jsonpatchoperationV1);
console.log(result);
```
