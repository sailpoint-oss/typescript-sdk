...
```typescript
import { LifecycleStatesApi } from '/api-client';
import { Configuration } from '/api-client';
import { LifecycleState } from '/api-client/dist/lifecycle_states/api';
...
import { LifecycleStatesApi } from '/api-client';
import { Configuration } from '/api-client';
import { SetLifecycleStateV1Request } from '/api-client/dist/lifecycle_states/api';
...
import { LifecycleStatesApi } from '/api-client';
import { Configuration } from '/api-client';
import { JsonPatchOperation } from '/api-client/dist/lifecycle_states/api';
