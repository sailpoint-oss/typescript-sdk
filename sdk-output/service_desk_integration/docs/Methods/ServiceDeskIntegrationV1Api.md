...
const result = await apiInstance.createServiceDeskIntegrationV1(servicedeskintegrationdtoV1);
console.log(result);
```
...
const result = await apiInstance.deleteServiceDeskIntegrationV1(id);
console.log(result);
```
...
const result = await apiInstance.getServiceDeskIntegrationTemplateV1(scriptName);
console.log(result);
```
...
const result = await apiInstance.getServiceDeskIntegrationV1(id);
console.log(result);
```
...
const result = await apiInstance.patchServiceDeskIntegrationV1(id, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.putServiceDeskIntegrationV1(id, servicedeskintegrationdtoV1);
console.log(result);
```
...
const result = await apiInstance.updateStatusCheckDetailsV1(queuedcheckconfigdetailsV1);
console.log(result);
```
