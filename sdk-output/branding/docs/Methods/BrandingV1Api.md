...
const result = await apiInstance.createBrandingItemV1(name, productName);
console.log(result);
```
...
const result = await apiInstance.deleteBrandingV1(name);
console.log(result);
```
...
const result = await apiInstance.getBrandingV1(name);
console.log(result);
```
...
const loginInformationalMessage: string = loginInformationalMessage_example; // login information message (optional)
const fileStandard: File = BINARY_DATA_HERE; // png file with logo (optional)
const result = await apiInstance.setBrandingItemV1(name, name2, productName);
console.log(result);
```
