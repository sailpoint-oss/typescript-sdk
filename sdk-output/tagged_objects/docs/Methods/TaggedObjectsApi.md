...
```typescript
import { TaggedObjectsApi } from '/api-client';
...
import { TaggedObjectsApi } from '/api-client';
import { Configuration } from '/api-client';
import { BulkRemoveTaggedObject } from '/api-client/dist/tagged_objects/api';
...
import { TaggedObjectsApi } from '/api-client';
import { Configuration } from '/api-client';
import { TaggedObject } from '/api-client/dist/tagged_objects/api';
...
import { TaggedObjectsApi } from '/api-client';
import { Configuration } from '/api-client';
import { BulkAddTaggedObject } from '/api-client/dist/tagged_objects/api';
