...
slug: /tools/sdk/typescript/access_model_metadata/models/search
...
**queryType** | **(optional)** `Querytype` |  | [default to undefined]
**queryVersion** | **(optional)** `string` |  | [default to undefined]
**query** | **(optional)** `Query` |  | [default to undefined]
...
**textQuery** | **(optional)** `Textquery` |  | [default to undefined]
**typeAheadQuery** | **(optional)** `Typeaheadquery` |  | [default to undefined]
...
**queryResultFilter** | **(optional)** `Queryresultfilter` |  | [default to undefined]
**aggregationType** | **(optional)** `Aggregationtype` |  | [default to undefined]
...
**aggregations** | **(optional)** `Searchaggregationspecification` |  | [default to undefined]
