...
const result = await apiInstance.createScheduledSearchV1(createScheduledSearchV1RequestV1);
console.log(result);
```
...
const result = await apiInstance.deleteScheduledSearchV1(id);
console.log(result);
```
...
const apiInstance = new ScheduledSearchV1Api(configuration);
const id: string = 2c91808568c529c60168cca6f90c1313; // ID of the requested document.
const result = await apiInstance.getScheduledSearchV1(id);
console.log(result);
```
...
const result = await apiInstance.unsubscribeScheduledSearchV1(id, typedreferenceV1);
console.log(result);
```
...
const result = await apiInstance.updateScheduledSearchV1(id, scheduledsearchV1);
console.log(result);
```
