...
const result = await apiInstance.cancelWorkflowExecutionV1(id);
console.log(result);
```
...
const result = await apiInstance.createExternalExecuteWorkflowV1(id);
console.log(result);
```
...
const apiInstance = new WorkflowsV1Api(configuration);
const id: string = c17bea3a-574d-453c-9e04-4365fbf5af0b; // Id of the workflow
const result = await apiInstance.createWorkflowExternalTriggerV1(id);
console.log(result);
```
...
const result = await apiInstance.createWorkflowV1(createWorkflowV1RequestV1);
console.log(result);
```
...
const apiInstance = new WorkflowsV1Api(configuration);
const id: string = c17bea3a-574d-453c-9e04-4365fbf5af0b; // Id of the Workflow
const result = await apiInstance.deleteWorkflowV1(id);
console.log(result);
```
...
const result = await apiInstance.getWorkflowExecutionHistoryV1(id);
console.log(result);
```
...
const apiInstance = new WorkflowsV1Api(configuration);
const id: string = c17bea3a-574d-453c-9e04-4365fbf5af0b; // Id of the workflow execution
const result = await apiInstance.getWorkflowExecutionHistoryV2(id);
console.log(result);
```
...
const result = await apiInstance.getWorkflowExecutionV1(id);
console.log(result);
```
...
const result = await apiInstance.getWorkflowExecutionsV1(id);
console.log(result);
```
...
const apiInstance = new WorkflowsV1Api(configuration);
const id: string = c17bea3a-574d-453c-9e04-4365fbf5af0b; // Id of the workflow
const result = await apiInstance.getWorkflowV1(id);
console.log(result);
```
...
const result = await apiInstance.patchWorkflowV1(id, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.putWorkflowV1(id, workflowbodyV1);
console.log(result);
```
...
const result = await apiInstance.testExternalExecuteWorkflowV1(id);
console.log(result);
```
...
const result = await apiInstance.testWorkflowV1(id, testWorkflowV1RequestV1);
console.log(result);
```
