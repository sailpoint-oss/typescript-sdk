...
const roleV1: RoleV1 = ; // 
const result = await apiInstance.createRoleV1(roleV1);
console.log(result);
```
...
const result = await apiInstance.deleteBulkRolesV1(rolebulkdeleterequestV1);
console.log(result);
```
...
const result = await apiInstance.deleteMetadataFromRoleByKeyAndValueV1(id, attributeKey, attributeValue);
console.log(result);
```
...
const result = await apiInstance.deleteRoleV1(id);
console.log(result);
```
...
const result = await apiInstance.getBulkUpdateStatusByIdV1(id);
console.log(result);
```
...
const result = await apiInstance.getRoleAssignedIdentitiesV1(id);
console.log(result);
```
...
const result = await apiInstance.getRoleEntitlementsV1(id);
console.log(result);
```
...
const apiInstance = new RolesV1Api(configuration);
const id: string = 2c91808a7813090a017814121e121518; // ID of the Role
const result = await apiInstance.getRoleV1(id);
console.log(result);
```
...
const result = await apiInstance.patchRoleV1(id, jsonpatchoperationV1);
console.log(result);
```
...
const attributeKey: string = iscPrivacy; // Technical name of the Attribute.
const attributeValue: string = public; // Technical name of the Attribute Value.
const result = await apiInstance.updateAttributeKeyAndValueToRoleV1(id, attributeKey, attributeValue);
console.log(result);
```
...
const result = await apiInstance.updateRolesMetadataByFilterV1(rolemetadatabulkupdatebyfilterrequestV1);
console.log(result);
```
...
const result = await apiInstance.updateRolesMetadataByIdsV1(rolemetadatabulkupdatebyidrequestV1);
console.log(result);
```
...
const result = await apiInstance.updateRolesMetadataByQueryV1(rolemetadatabulkupdatebyqueryrequestV1);
console.log(result);
```
