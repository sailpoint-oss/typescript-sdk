...
const result = await apiInstance.getIdentityAccessSummariesV1(id, type);
console.log(result);
```
...
const result = await apiInstance.getIdentityDecisionSummaryV1(id);
console.log(result);
```
...
const result = await apiInstance.getIdentitySummariesV1(id);
console.log(result);
```
...
const result = await apiInstance.getIdentitySummaryV1(id, identitySummaryId);
console.log(result);
```
