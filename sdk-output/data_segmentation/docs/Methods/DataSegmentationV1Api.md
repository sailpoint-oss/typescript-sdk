...
const result = await apiInstance.createDataSegmentV1(dataSegmentV1);
console.log(result);
```
...
const result = await apiInstance.deleteDataSegmentV1(segmentId);
console.log(result);
```
...
const xSailPointExperimental: string = true; // Use this header to enable this experimental API. (optional)
const result = await apiInstance.getDataSegmentIdentityMembershipV1(identityId);
console.log(result);
```
...
const xSailPointExperimental: string = true; // Use this header to enable this experimental API. (optional)
const result = await apiInstance.getDataSegmentV1(segmentId);
console.log(result);
```
...
const xSailPointExperimental: string = true; // Use this header to enable this experimental API. (optional)
const result = await apiInstance.getDataSegmentationEnabledForUserV1(identityId);
console.log(result);
```
...
const xSailPointExperimental: string = true; // Use this header to enable this experimental API. (optional)
const result = await apiInstance.patchDataSegmentV1(segmentId, requestBody);
console.log(result);
```
...
const xSailPointExperimental: string = true; // Use this header to enable this experimental API. (optional)
const result = await apiInstance.publishDataSegmentV1(segmentId, requestBody);
console.log(result);
```
