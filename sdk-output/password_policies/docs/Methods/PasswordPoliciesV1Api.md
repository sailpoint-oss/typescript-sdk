...
const result = await apiInstance.createPasswordPolicyV1(passwordpolicyv3dtoV1);
console.log(result);
```
...
const xSailPointExperimental: string = true; // Use this header to enable this experimental API. (optional)
const result = await apiInstance.deletePasswordPolicyV1(id);
console.log(result);
```
...
const xSailPointExperimental: string = true; // Use this header to enable this experimental API. (optional)
const result = await apiInstance.getPasswordPolicyByIdV1(id);
console.log(result);
```
...
const xSailPointExperimental: string = true; // Use this header to enable this experimental API. (optional)
const result = await apiInstance.setPasswordPolicyV1(id, passwordpolicyv3dtoV1);
console.log(result);
```
