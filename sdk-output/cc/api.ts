 ...
 * 
 * @export
 * @interface UpdateClusterRequestCC
 */
export interface UpdateClusterRequestCC {
    /**
     * The ID of the cluster to update
     * @type {string}
     * @memberof UpdateClusterRequestCC
     */
    'id'?: string;
    /**
...
/**
 * ClusterCCApi - axios parameter creator
 * @export
 */
export const ClusterCCApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Updates a Managed Cluster.
         * @summary Update Cluster
         * @param {UpdateClusterRequestCC} updateClusterRequestCC body to update the managed cluster with
         * @param {*} [axiosOptions] Override http request option.
         * @throws {RequiredError}
         */
        updateCluster: async (updateClusterRequestCC: UpdateClusterRequestCC, axiosOptions: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'updateClusterRequestCC' is not null or undefined
            assertParamExists('updateCluster', 'updateClusterRequestCC', updateClusterRequestCC)
            const localVarPath = `/cc/api/cluster/update/`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...axiosOptions.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(updateClusterRequestCC, localVarRequestOptions, configuration)
...
/**
 * ClusterCCApi - functional programming interface
 * @export
 */
export const ClusterCCApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = ClusterCCApiAxiosParamCreator(configuration)
    return {
        /**
         * Updates a Managed Cluster.
         * @summary Update Cluster
         ...
         * @throws {RequiredError}
         */
        async updateCluster(updateClusterRequestCC: UpdateClusterRequestCC, axiosOptions?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateCluster(updateClusterRequestCC, axiosOptions);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * ClusterCCApi - factory interface
 * @export
 */
export const ClusterCCApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = ClusterCCApiFp(configuration)
    return {
        /**
         * Updates a Managed Cluster.
         * @summary Update Cluster
         ...
         * @throws {RequiredError}
         */
        updateCluster(updateClusterRequestCC: UpdateClusterRequestCC, axiosOptions?: any): AxiosPromise<void> {
            return localVarFp.updateCluster(updateClusterRequestCC, axiosOptions).then((request) => request(axios, basePath));
        },
    };
};
 ...
 * @export
 * @interface ClusterCCApiUpdateClusterRequest
 */
export interface ClusterCCApiUpdateClusterRequest {
    /**
     * body to update the managed cluster with
     * @type {UpdateClusterRequestCC}
     * @memberof ClusterCCApiUpdateCluster
     */
    readonly updateClusterRequestCC: UpdateClusterRequestCC
}

/**
 * ClusterCCApi - object-oriented interface
 * @export
 * @class ClusterCCApi
 * @extends {BaseAPI}
 */
export class ClusterCCApi extends BaseAPI {
    /**
     * Updates a Managed Cluster.
     * @summary Update Cluster
     * @param {ClusterCCApiUpdateClusterRequest} requestParameters Request parameters.
     * @param {*} [axiosOptions] Override http request option.
     * @throws {RequiredError}
     * @memberof ClusterCCApi
     */
    public updateCluster(requestParameters: ClusterCCApiUpdateClusterRequest, axiosOptions?: AxiosRequestConfig) {
        return ClusterCCApiFp(this.configuration).updateCluster(requestParameters.updateClusterRequestCC, axiosOptions).then((request) => request(this.axios, this.basePath));
    }
}
