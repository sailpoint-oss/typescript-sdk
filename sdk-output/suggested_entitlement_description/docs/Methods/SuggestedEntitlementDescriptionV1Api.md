...
const result = await apiInstance.approveBulkEntitlementRecommendationsV1(bulkapproveentitlementrecommendationrequestV1);
console.log(result);
```
...
const result = await apiInstance.createAutoWriteSettingsV1(autowritesettingV1);
console.log(result);
```
...
const result = await apiInstance.getSedBatchStatsV1(batchId);
console.log(result);
```
...
const result = await apiInstance.patchEntitlementRecommendationV1(id, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.patchSedV1(id, sedpatchV1);
console.log(result);
```
...
const result = await apiInstance.submitEntitlementRecommendationsAssignmentV1(entitlementrecommendationassignrequestV1);
console.log(result);
```
...
const result = await apiInstance.submitSedApprovalV1(sedapprovalV1);
console.log(result);
```
...
const result = await apiInstance.submitSedAssignmentV1(sedassignmentV1);
console.log(result);
```
...
const result = await apiInstance.updateAutoWriteSettingsV1(autowritesettingpatchV1);
console.log(result);
```
