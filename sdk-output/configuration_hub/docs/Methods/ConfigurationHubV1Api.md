...
const result = await apiInstance.createDeployV1(deployrequestV1);
console.log(result);
```
...
const result = await apiInstance.createObjectMappingV1(sourceOrg, objectmappingrequestV1);
console.log(result);
```
...
const result = await apiInstance.createObjectMappingsV1(sourceOrg, objectmappingbulkcreaterequestV1);
console.log(result);
```
...
const result = await apiInstance.createScheduledActionV1(scheduledactionpayloadV1);
console.log(result);
```
...
const result = await apiInstance.createUploadedConfigurationV1(data, name);
console.log(result);
```
...
const result = await apiInstance.deleteBackupV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteDraftV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteObjectMappingV1(sourceOrg, objectMappingId);
console.log(result);
```
...
const result = await apiInstance.deleteScheduledActionV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteUploadedConfigurationV1(id);
console.log(result);
```
...
const result = await apiInstance.getDeployV1(id);
console.log(result);
```
...
const apiInstance = new ConfigurationHubV1Api(configuration);
const sourceOrg: string = source-org; // The name of the source org.
const result = await apiInstance.getObjectMappingsV1(sourceOrg);
console.log(result);
```
...
const apiInstance = new ConfigurationHubV1Api(configuration);
const id: string = 3d0fe04b-57df-4a46-a83b-8f04b0f9d10b; // The id of the uploaded configuration.
const result = await apiInstance.getUploadedConfigurationV1(id);
console.log(result);
```
...
const result = await apiInstance.updateObjectMappingsV1(sourceOrg, objectmappingbulkpatchrequestV1);
console.log(result);
```
...
const result = await apiInstance.updateScheduledActionV1(id, jsonpatchV1);
console.log(result);
```
