...
const result = await apiInstance.createOauthClientV1(createoauthclientrequestV1);
console.log(result);
```
...
const result = await apiInstance.deleteOauthClientV1(id);
console.log(result);
```
...
const apiInstance = new OAuthClientsV1Api(configuration);
const id: string = ef38f94347e94562b5bb8424a56397d8; // The OAuth client id
const result = await apiInstance.getOauthClientV1(id);
console.log(result);
```
...
const result = await apiInstance.patchOauthClientV1(id, jsonpatchoperationV1);
console.log(result);
```
