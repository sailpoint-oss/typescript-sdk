...
const result = await apiInstance.createPersonalAccessTokenV1(createpersonalaccesstokenrequestV1);
console.log(result);
```
...
const result = await apiInstance.deletePersonalAccessTokenV1(id);
console.log(result);
```
...
const result = await apiInstance.patchPersonalAccessTokenV1(id, jsonpatchoperationV1);
console.log(result);
```
