...
keywords: ['typescript', 'TypeScript', 'sdk', 'Source', 'v1Source']
slug: /tools/sdk/typescript/sources/models/source
...
**owner** | `SourceOwner` |  | [default to undefined]
**cluster** | **(optional)** `SourceCluster` |  | [default to undefined]
**accountCorrelationConfig** | **(optional)** `SourceAccountCorrelationConfig` |  | [default to undefined]
**accountCorrelationRule** | **(optional)** `SourceAccountCorrelationRule` |  | [default to undefined]
**managerCorrelationMapping** | **(optional)** `SourceManagerCorrelationMapping` |  | [default to undefined]
**managerCorrelationRule** | **(optional)** `SourceManagerCorrelationRule` |  | [default to undefined]
**beforeProvisioningRule** | **(optional)** `SourceBeforeProvisioningRule` |  | [default to undefined]
**schemas** | **(optional)** `Array<SourceSchemasInner>` | List of references to schema objects. | [default to undefined]
**passwordPolicies** | **(optional)** `Array<SourcePasswordPoliciesInner>` | List of references to the associated PasswordPolicy objects. | [default to undefined]
...
**managementWorkgroup** | **(optional)** `SourceManagementWorkgroup` |  | [default to undefined]
