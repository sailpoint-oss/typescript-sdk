...
const result = await apiInstance.approveNonEmployeeRequestV1(id, nonemployeeapprovaldecisionV1);
console.log(result);
```
...
const result = await apiInstance.createNonEmployeeRecordV1(nonemployeerequestbodyV1);
console.log(result);
```
...
const result = await apiInstance.createNonEmployeeRequestV1(nonemployeerequestbodyV1);
console.log(result);
```
...
const result = await apiInstance.createNonEmployeeSourceSchemaAttributesV1(sourceId, nonemployeeschemaattributebodyV1);
console.log(result);
```
...
const result = await apiInstance.createNonEmployeeSourceV1(nonemployeesourcerequestbodyV1);
console.log(result);
```
...
const result = await apiInstance.deleteNonEmployeeRecordV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteNonEmployeeRecordsInBulkV1(deleteNonEmployeeRecordsInBulkV1RequestV1);
console.log(result);
```
...
const result = await apiInstance.deleteNonEmployeeRequestV1(id);
console.log(result);
```
...
const sourceId: string = ef38f94347e94562b5bb8424a56397d8; // The Source id
const result = await apiInstance.deleteNonEmployeeSchemaAttributeV1(attributeId, sourceId);
console.log(result);
```
...
const apiInstance = new NonEmployeeLifecycleManagementV1Api(configuration);
const sourceId: string = ef38f94347e94562b5bb8424a56397d8; // The Source id
const result = await apiInstance.deleteNonEmployeeSourceSchemaAttributesV1(sourceId);
console.log(result);
```
...
const result = await apiInstance.deleteNonEmployeeSourceV1(sourceId);
console.log(result);
```
...
const result = await apiInstance.exportNonEmployeeRecordsV1(id);
console.log(result);
```
...
const result = await apiInstance.exportNonEmployeeSourceSchemaTemplateV1(id);
console.log(result);
```
...
const result = await apiInstance.getNonEmployeeApprovalSummaryV1(requestedFor);
console.log(result);
```
...
const result = await apiInstance.getNonEmployeeApprovalV1(id);
console.log(result);
```
...
const apiInstance = new NonEmployeeLifecycleManagementV1Api(configuration);
const id: string = e136567de87e4d029e60b3c3c55db56d; // Source ID (UUID)
const result = await apiInstance.getNonEmployeeBulkUploadStatusV1(id);
console.log(result);
```
...
const apiInstance = new NonEmployeeLifecycleManagementV1Api(configuration);
const id: string = ef38f94347e94562b5bb8424a56397d8; // Non-Employee record id (UUID)
const result = await apiInstance.getNonEmployeeRecordV1(id);
console.log(result);
```
...
const result = await apiInstance.getNonEmployeeRequestSummaryV1(requestedFor);
console.log(result);
```
...
const result = await apiInstance.getNonEmployeeRequestV1(id);
console.log(result);
```
...
const attributeId: string = ef38f94347e94562b5bb8424a56397d8; // The Schema Attribute Id (UUID)
const sourceId: string = ef38f94347e94562b5bb8424a56397d8; // The Source id
const result = await apiInstance.getNonEmployeeSchemaAttributeV1(attributeId, sourceId);
console.log(result);
```
...
const apiInstance = new NonEmployeeLifecycleManagementV1Api(configuration);
const sourceId: string = ef38f94347e94562b5bb8424a56397d8; // The Source id
const result = await apiInstance.getNonEmployeeSourceSchemaAttributesV1(sourceId);
console.log(result);
```
...
const result = await apiInstance.getNonEmployeeSourceV1(sourceId);
console.log(result);
```
...
const result = await apiInstance.importNonEmployeeRecordsInBulkV1(id, data);
console.log(result);
```
...
const filters: string = sourceId eq "2c91808568c529c60168cca6f90c1313"; // Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **sourceId**: *eq*  (optional)
const result = await apiInstance.listNonEmployeeRequestsV1(requestedFor);
console.log(result);
```
...
const result = await apiInstance.patchNonEmployeeRecordV1(id, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.patchNonEmployeeSchemaAttributeV1(attributeId, sourceId, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.patchNonEmployeeSourceV1(sourceId, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.rejectNonEmployeeRequestV1(id, nonemployeerejectapprovaldecisionV1);
console.log(result);
```
...
const result = await apiInstance.updateNonEmployeeRecordV1(id, nonemployeerequestbodyV1);
console.log(result);
```
