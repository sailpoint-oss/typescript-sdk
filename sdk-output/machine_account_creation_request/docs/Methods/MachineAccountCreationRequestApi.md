...
```typescript
import { MachineAccountCreationRequestApi } from '/api-client';
import { Configuration } from '/api-client';
import { MachineAccountCreateRequestInput } from '/api-client/dist/machine_account_creation_request/api';
