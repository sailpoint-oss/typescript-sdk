...
const result = await apiInstance.createSegmentV1(segmentV1);
console.log(result);
```
...
const result = await apiInstance.deleteSegmentV1(id);
console.log(result);
```
...
const result = await apiInstance.getSegmentV1(id);
console.log(result);
```
...
const result = await apiInstance.patchSegmentV1(id, requestBody);
console.log(result);
```
