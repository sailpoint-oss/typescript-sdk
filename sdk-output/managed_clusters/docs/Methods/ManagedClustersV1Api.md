...
const result = await apiInstance.createManagedClusterV1(managedclusterrequestV1);
console.log(result);
```
...
const result = await apiInstance.deleteManagedClusterV1(id);
console.log(result);
```
...
const result = await apiInstance.getClientLogConfigurationV1(id);
console.log(result);
```
...
const apiInstance = new ManagedClustersV1Api(configuration);
const id: string = 2c9180897de347a2017de8859e8c5039; // Managed cluster ID.
const result = await apiInstance.getManagedClusterV1(id);
console.log(result);
```
...
const result = await apiInstance.putClientLogConfigurationV1(id, putClientLogConfigurationV1RequestV1);
console.log(result);
```
...
const result = await apiInstance.updateManagedClusterV1(id, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.updateV1(id);
console.log(result);
```
