...
```typescript
import { ManagedClustersApi } from '/api-client';
import { Configuration } from '/api-client';
import { ManagedClusterRequest } from '/api-client/dist/managed_clusters/api';
...
import { ManagedClustersApi } from '/api-client';
import { Configuration } from '/api-client';
import { PutClientLogConfigurationV1Request } from '/api-client/dist/managed_clusters/api';
...
import { ManagedClustersApi } from '/api-client';
import { Configuration } from '/api-client';
import { JsonPatchOperation } from '/api-client/dist/managed_clusters/api';
