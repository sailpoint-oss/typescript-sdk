...
const result = await apiInstance.createConnectorCustomizerV1(connectorcustomizercreaterequestV1);
console.log(result);
```
...
const result = await apiInstance.createConnectorCustomizerVersionV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteConnectorCustomizerV1(id);
console.log(result);
```
...
const result = await apiInstance.getConnectorCustomizerV1(id);
console.log(result);
```
...
const result = await apiInstance.putConnectorCustomizerV1(id);
console.log(result);
```
