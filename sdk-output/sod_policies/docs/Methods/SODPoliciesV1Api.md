...
const result = await apiInstance.createSodPolicyV1(sodpolicyV1);
console.log(result);
```
...
const result = await apiInstance.deleteSodPolicyScheduleV1(id);
console.log(result);
```
...
const result = await apiInstance.deleteSodPolicyV1(id);
console.log(result);
```
...
const result = await apiInstance.getCustomViolationReportV1(reportResultId, fileName);
console.log(result);
```
...
const apiInstance = new SODPoliciesV1Api(configuration);
const reportResultId: string = ef38f94347e94562b5bb8424a56397d8; // The ID of the report reference to download.
const result = await apiInstance.getDefaultViolationReportV1(reportResultId);
console.log(result);
```
...
const result = await apiInstance.getSodPolicyScheduleV1(id);
console.log(result);
```
...
const result = await apiInstance.getSodPolicyV1(id);
console.log(result);
```
...
const result = await apiInstance.getSodViolationReportRunStatusV1(reportResultId);
console.log(result);
```
...
const result = await apiInstance.getSodViolationReportStatusV1(id);
console.log(result);
```
...
const result = await apiInstance.patchSodPolicyV1(id, jsonpatchoperationV1);
console.log(result);
```
...
const result = await apiInstance.putPolicyScheduleV1(id, sodpolicyscheduleV1);
console.log(result);
```
...
const result = await apiInstance.putSodPolicyV1(id, sodpolicyV1);
console.log(result);
```
...
const result = await apiInstance.startEvaluateSodPolicyV1(id);
console.log(result);
```
...
const apiInstance = new SODPoliciesV1Api(configuration);
const id: string = ef38f943-47e9-4562-b5bb-8424a56397d8; // The SOD policy ID to run.
const result = await apiInstance.startSodPolicyV1(id);
console.log(result);
```
