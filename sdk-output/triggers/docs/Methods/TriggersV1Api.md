...
const result = await apiInstance.completeTriggerInvocationV1(id, completeinvocationV1);
console.log(result);
```
...
const result = await apiInstance.createSubscriptionV1(subscriptionpostrequestV1);
console.log(result);
```
...
const result = await apiInstance.deleteSubscriptionV1(id);
console.log(result);
```
...
const result = await apiInstance.startTestTriggerInvocationV1(testinvocationV1);
console.log(result);
```
...
const result = await apiInstance.testSubscriptionFilterV1(validatefilterinputdtoV1);
console.log(result);
```
...
const result = await apiInstance.updateSubscriptionV1(id, subscriptionputrequestV1);
console.log(result);
```
