...
const result = await apiInstance.createManagedClientV1(managedclientrequestV1);
console.log(result);
```
...
const result = await apiInstance.deleteManagedClientV1(id);
console.log(result);
```
...
const result = await apiInstance.getManagedClientHealthIndicatorsV1(id);
console.log(result);
```
...
const result = await apiInstance.getManagedClientStatusV1(id, type);
console.log(result);
```
...
const apiInstance = new ManagedClientsV1Api(configuration);
const id: string = 4440278c-0ce2-41ee-a0a9-f5cfd5e8d3b7; // Managed client ID.
const result = await apiInstance.getManagedClientV1(id);
console.log(result);
```
...
const result = await apiInstance.updateManagedClientV1(id, jsonpatchoperationV1);
console.log(result);
```
